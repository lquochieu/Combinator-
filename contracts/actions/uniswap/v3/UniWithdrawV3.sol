...
contract UniWithdrawV3 is ActionBase, UniV3Helper {
    ...
    function executeAction(
        ...
        (uint256 amount0, , bytes memory logData) = _uniWithdrawFromPosition(
            uniData
        );
    ...
    function _uniWithdrawFromPosition(
    ...
    function _uniWithdraw(
        Params memory _uniData
    ) internal returns (uint256 amount0, uint256 amount1) {
        IUniswapV3NonfungiblePositionManager.DecreaseLiquidityParams
            memory decreaseLiquidityParams = IUniswapV3NonfungiblePositionManager
