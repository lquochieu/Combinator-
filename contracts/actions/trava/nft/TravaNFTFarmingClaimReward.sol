...
contract TravaNFTFarmingClaimReard is ActionBase, TravaNFTHelper {
    ...
    function executeAction(
        ...
        emit ActionEvent("TravaNFTFarmingClaimReard", logData);
    ...
    function executeActionDirect(
        ...
        logger.logActionDirectEvent("TravaNFTFarmingClaimReard", logData);
    }
    ...
    function _claimReward(
        ...
        IFarming(_farming).claimReward(_ids, _level);
